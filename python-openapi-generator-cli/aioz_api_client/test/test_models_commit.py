...
class TestModelsCommit(unittest.TestCase):
    """ModelsCommit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelsCommit:
        """Test ModelsCommit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelsCommit`
        """
        model = ModelsCommit()
        if include_optional:
            return ModelsCommit(
