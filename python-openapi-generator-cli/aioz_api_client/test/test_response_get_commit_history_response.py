...
class TestResponseGetCommitHistoryResponse(unittest.TestCase):
    """ResponseGetCommitHistoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseGetCommitHistoryResponse:
        """Test ResponseGetCommitHistoryResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseGetCommitHistoryResponse`
        """
        model = ResponseGetCommitHistoryResponse()
        if include_optional:
            return ResponseGetCommitHistoryResponse(
                data = aioz_api_client.models.response/get_commit_history_data.response.GetCommitHistoryData(
                    commit = [
    ...
    def testResponseGetCommitHistoryResponse(self):
        """Test ResponseGetCommitHistoryResponse"""
