...
class ResponseApiKeyHistoryListResponse(BaseModel):
    """
    ResponseApiKeyHistoryListResponse
    """ # noqa: E501
    data: Optional[ResponseApiKeyHistoryListData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseApiKeyHistoryListData.from_dict(obj["data"]) if obj.get("data") is not None else None,
