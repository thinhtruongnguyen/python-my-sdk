...
class ResponseGetListModelVersioningLiteResponse(BaseModel):
    """
    ResponseGetListModelVersioningLiteResponse
    """ # noqa: E501
    data: Optional[ResponseGetListModelVersioningsLiteData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseGetListModelVersioningsLiteData.from_dict(obj["data"]) if obj.get("data") is not None else None,
