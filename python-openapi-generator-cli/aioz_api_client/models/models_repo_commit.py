...
class ModelsRepoCommit(BaseModel):
    """
    ModelsRepoCommit
    """ # noqa: E501
    author: Optional[ModelsCommitUser] = None
    committer: Optional[ModelsCommitUser] = None
    message: Optional[StrictStr] = None
    tree: Optional[ModelsCommitMeta] = None
    __properties: ClassVar[List[str]] = ["author", "committer", "message", "tree"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author": ModelsCommitUser.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "committer": ModelsCommitUser.from_dict(obj["committer"]) if obj.get("committer") is not None else None,
            "message": obj.get("message"),
            "tree": ModelsCommitMeta.from_dict(obj["tree"]) if obj.get("tree") is not None else None
        })
        return _obj
