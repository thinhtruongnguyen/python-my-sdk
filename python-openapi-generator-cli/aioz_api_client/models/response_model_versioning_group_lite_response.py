...
class ResponseModelVersioningGroupLiteResponse(BaseModel):
    """
    ResponseModelVersioningGroupLiteResponse
    """ # noqa: E501
    data: Optional[ModelsModelVersioningGroupLite] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsModelVersioningGroupLite.from_dict(obj["data"]) if obj.get("data") is not None else None,
