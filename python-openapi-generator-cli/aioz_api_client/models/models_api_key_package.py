...
class ModelsApiKeyPackage(BaseModel):
    """
    ModelsApiKeyPackage
    """ # noqa: E501
    model_id: Optional[StrictStr] = None
    uses_remaining: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["model_id", "uses_remaining"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "uses_remaining": obj.get("uses_remaining")
        })
        return _obj
