...
class ResponseModelVersioningResponse(BaseModel):
    """
    ResponseModelVersioningResponse
    """ # noqa: E501
    data: Optional[ModelsModelVersioning] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsModelVersioning.from_dict(obj["data"]) if obj.get("data") is not None else None,
