...
class ResponseGetTaskResultResponse(BaseModel):
    """
    ResponseGetTaskResultResponse
    """ # noqa: E501
    data: Optional[ResponseGetTaskResultData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseGetTaskResultData.from_dict(obj["data"]) if obj.get("data") is not None else None,
