...
class ResponseEstimateCostData(BaseModel):
    """
    ResponseEstimateCostData
    """ # noqa: E501
    cost: Optional[Union[StrictFloat, StrictInt]] = None
    symbol: Optional[StrictStr] = '$'
    unit: Optional[StrictStr] = 'USD'
    __properties: ClassVar[List[str]] = ["cost", "symbol", "unit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit") if obj.get("unit") is not None else 'USD'
        })
        return _obj
