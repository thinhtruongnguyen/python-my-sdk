...
class ResponseGetTaskStatisticsResponse(BaseModel):
    """
    ResponseGetTaskStatisticsResponse
    """ # noqa: E501
    data: Optional[ResponseGetTaskStatisticsData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseGetTaskStatisticsData.from_dict(obj["data"]) if obj.get("data") is not None else None,
