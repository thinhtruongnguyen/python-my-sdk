...
class ResponseWalletWithAddressResponse(BaseModel):
    """
    ResponseWalletWithAddressResponse
    """ # noqa: E501
    data: Optional[ModelsWalletWithAddress] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsWalletWithAddress.from_dict(obj["data"]) if obj.get("data") is not None else None,
