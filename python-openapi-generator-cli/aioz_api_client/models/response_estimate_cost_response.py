...
class ResponseEstimateCostResponse(BaseModel):
    """
    ResponseEstimateCostResponse
    """ # noqa: E501
    data: Optional[ResponseEstimateCostData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseEstimateCostData.from_dict(obj["data"]) if obj.get("data") is not None else None,
