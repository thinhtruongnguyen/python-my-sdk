...
class ResponseGetCommitHistoryResponse(BaseModel):
    """
    ResponseGetCommitHistoryResponse
    """ # noqa: E501
    data: Optional[ResponseGetCommitHistoryData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseGetCommitHistoryData.from_dict(obj["data"]) if obj.get("data") is not None else None,
