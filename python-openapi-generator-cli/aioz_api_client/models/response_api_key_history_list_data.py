...
class ResponseApiKeyHistoryListData(BaseModel):
    """
    ResponseApiKeyHistoryListData
    """ # noqa: E501
    records: Optional[List[ModelsApiKeyHistories]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [ModelsApiKeyHistories.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
            "total": obj.get("total")
        })
        return _obj
