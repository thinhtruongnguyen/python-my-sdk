...
class ModelsApiKeyInfo(BaseModel):
    """
    ModelsApiKeyInfo
    """ # noqa: E501
    api_price: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["api_price", "commit_hash", "input_format", "model_description", "model_id", "output_format"]
