...
class ResponseQueueTaskResponse(BaseModel):
    """
    ResponseQueueTaskResponse
    """ # noqa: E501
    data: Optional[ModelsQueueTask] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsQueueTask.from_dict(obj["data"]) if obj.get("data") is not None else None,
