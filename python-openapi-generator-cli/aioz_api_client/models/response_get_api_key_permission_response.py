...
class ResponseGetApiKeyPermissionResponse(BaseModel):
    """
    ResponseGetApiKeyPermissionResponse
    """ # noqa: E501
    data: Optional[ResponseGetApiKeyPermissionData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseGetApiKeyPermissionData.from_dict(obj["data"]) if obj.get("data") is not None else None,
