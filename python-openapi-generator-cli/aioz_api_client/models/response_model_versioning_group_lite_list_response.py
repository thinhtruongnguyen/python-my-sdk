...
class ResponseModelVersioningGroupLiteListResponse(BaseModel):
    """
    ResponseModelVersioningGroupLiteListResponse
    """ # noqa: E501
    data: Optional[ResponseModelVersioningGroupLiteListData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseModelVersioningGroupLiteListData.from_dict(obj["data"]) if obj.get("data") is not None else None,
