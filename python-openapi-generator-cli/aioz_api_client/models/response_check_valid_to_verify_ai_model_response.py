...
class ResponseCheckValidToVerifyAiModelResponse(BaseModel):
    """
    ResponseCheckValidToVerifyAiModelResponse
    """ # noqa: E501
    data: Optional[ResponseCheckValidToVerifyAiModelData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseCheckValidToVerifyAiModelData.from_dict(obj["data"]) if obj.get("data") is not None else None,
