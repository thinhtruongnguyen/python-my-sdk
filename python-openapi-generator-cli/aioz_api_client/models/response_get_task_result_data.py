...
class ResponseGetTaskResultData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["result", "status", "success", "traceback"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": ResponseResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
