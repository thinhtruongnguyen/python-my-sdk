...
class ResponseCheckModelIsServingResponse(BaseModel):
    """
    ResponseCheckModelIsServingResponse
    """ # noqa: E501
    data: Optional[ResponseCheckModelIsServingData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ResponseCheckModelIsServingData.from_dict(obj["data"]) if obj.get("data") is not None else None,
