...
class ResponseModelVersioningGroupLiteListData(BaseModel):
    """
    ResponseModelVersioningGroupLiteListData
    """ # noqa: E501
    records: Optional[List[ModelsModelVersioningGroupLite]] = None
    total: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["records", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "records": [ModelsModelVersioningGroupLite.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
            "total": obj.get("total")
        })
        return _obj
