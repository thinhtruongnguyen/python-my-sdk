...
class ResponseApiKeyInfoResponse(BaseModel):
    """
    ResponseApiKeyInfoResponse
    """ # noqa: E501
    data: Optional[ModelsApiKeyInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": ModelsApiKeyInfo.from_dict(obj["data"]) if obj.get("data") is not None else None,
